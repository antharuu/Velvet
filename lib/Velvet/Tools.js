...
var VelvetConfig_1 = __importDefault(require("./VelvetConfig"));
/**
 ...
 * @return indent
 */
function getIndentOf(line, tabSize) {
    if (tabSize === void 0) { tabSize = undefined; }
    if (!tabSize)
...
function getBlocksOf(velvetCode) {
    ...
    var blocks = [];
    var mainLine = "", currentIndent = getIndentOf(mainLine), current_block = [];
    ...
    while (lines.length > 0) {
        ...
        var line = (_b = lines[0]) !== null && _b !== void 0 ? _b : "";
 ...
 * @returns Tab regex
 */
function getTabRegex(forceTabSize) {
    if (forceTabSize === void 0) { forceTabSize = undefined; }
    var tabSize = forceTabSize !== null && forceTabSize !== void 0 ? forceTabSize : VelvetConfig_1.default.get().tabSize;
    if (tabSize == 2) {
        return /^(  )/;
    }
    else if (tabSize == 4) {
